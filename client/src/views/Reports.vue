    ...
    <div v-else>
          ...
          <table class="reports-table">
            ...
            <tbody>
              <tr v-for="(month, index) in monthlyData" :key="month.month">
                ...
                <td>{{ formatNumber(month.order_count) }}</td>
      ...
      <div class="stats-grid">
        ...
        <div class="stat-card">
          ...
          <div class="stat-value">{{ bestQuarter || t('reports.nA') }}</div>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  setup() {
    ...
    // O(1) max computed once when monthlyData changes
    ...
    const loadData = async () => {
      ...
      try {
        ...
        error.value = t('reports.errorLoading') + err.message
      } finally {
        loading.value = false
      }
    }
